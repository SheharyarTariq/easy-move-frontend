import { blogPosts, featuredPost } from '../../../lib/blog-posts';
...
export async function generateMetadata(props:{ params : Params}) {
  ...
  if (!post) {
    return {
      title: "Post Not Found | Galaxy Removals",
      description: "The blog post you are looking for does not exist.",
    };
  }

  return {
    title: `${post.title} | Galaxy Removals Blog`,
    description: post.excerpt,
    openGraph: {
      title: post.title,
      description: post.excerpt,
      url: `https://galaxyremovals.co.uk/blog/${post.slug}`,
      images: [
        {
          url: post.image.src,
          width: 1200,
