...
import { blogPosts, featuredPost, BlogPost } from "../../lib/blog-posts";
...
const Blog = () => {
  ...
  const getFilteredPosts = (category: string) => {
    ...
    return blogPosts.filter((post) =>
      post.category.toLowerCase().startsWith(category.toLowerCase())
    );
  };
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <TabsList className="grid w-full grid-cols-3 mb-12 max-w-2xl mx-auto">
              ...
              <TabsTrigger value="moving" className="truncate">
                Moving Tips
              </TabsTrigger>
              <TabsTrigger value="packing" className="truncate">
                Packing Tips
              </TabsTrigger>
            </TabsList>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="bg-card rounded-2xl sm:p-12 p-6 shadow-hero-custom border border-border max-w-4xl mx-auto">
            ...
            <p className="text-base text-muted-foreground mb-8 max-w-2xl mx-auto">
              Join thousands of satisfied customers who have made their move
              with confidence. Get your free quote today and discover why
              GalaxyRemovals is the UK&apos;s trusted moving partner.
            </p>
